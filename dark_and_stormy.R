...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/heejucho/36-350/main/README.md")
```
...
test_that("return the value 0 for input a", expect_equal(f("a"),0))
test_that("return the value 0 for input a", expect_equivalent(f("a"),0))
test_that("return the value 0 for input a", expect_lt(f("a"),1)) 

#Test Didn't Pass 

test_that("return the value 0.693 for input b", expect_identical(f("a"),0.693)) 
#did not pass because f(a) is not identical to 0.693.

test_that("return the value of input b is strictly more than 1", expect_gt(f("b"),1))
#did not pass because f(b) is not strictly more than 1 with difference about -0.307 
...
test_that("return the value 0 for input a", expect_equivalent(f("a"),0))
test_that("return the value 0 for input a", expect_lt(f("a"),1)) 
test_that("return the value 0.693 for input b", expect_identical(f("a"),0)) 
test_that("return the value of input b is strictly more than 0", expect_gt(f("b"),0))
